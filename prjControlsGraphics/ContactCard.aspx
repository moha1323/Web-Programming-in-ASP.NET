...
<body style="z-index: 1; left: 0px; top: 0px; position: absolute; height: 939px; width: 680px">
    <form id="form1" runat="server">
    <div class = "aspNetHidden">
    <input type = "hidden" name = "VIEWSTATE" id = "_VIEWSTATE" value = "Welcome"/>
    </div>
    <div style="font-family: 'Times New Roman'; font-size: x-small; text-align: left; background-color: #ffffcc; border: thin solid #000000; padding: 20px; position: relative; width: 290px; height: 415px; top: 2px; left: -1px;">
        ...
        <asp:Panel ID="cardPanel" runat="server" HorizontalAlign="Center" style="z-index: 1; left: 342px; top: 21px; position: absolute; height: 518px; width: 327px; margin-top: 0px" Width="350px">
            <br />
            <asp:Image ID="imgContactFace" runat="server" Height="245px" ImageAlign="Middle" ImageUrl="C:\Users\Yahyam816\Desktop\ASP.NET\prjControlsGraphics\Hoony.png" Width="130px" />
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:Label ID="lblFooter" runat="server" Height="20px" Width="195px"></asp:Label>
        </asp:Panel>
    </form>
</body>
</html>
